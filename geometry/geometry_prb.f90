...
!
  ...
  call test20324 ( )
  call test20325 ( )
  call tetrahedron_solid_angles_3d_test ( )
  call test2033 ( )
  call test204 ( )
  call test205 ( )
  call test206 ( )
...
!
  ...
  real ( kind = 8 ) p1(2)
  real ( kind = 8 ), dimension(2,test_num) :: p1_test = reshape ( (/ &
    0.0D+00, 0.0D+00, &
    0.0D+00, 0.0D+00, &
    3.0D+00, 0.0D+00 /), (/ 2, test_num /) )
  real ( kind = 8 ) p2(2)
  real ( kind = 8 ), dimension(2,test_num) :: p2_test = reshape ( (/ &
    3.0D+00, 0.0D+00, &
    3.0D+00, 0.0D+00, &
    3.0D+00, 0.0D+00 /), (/ 2, test_num /) )
  real ( kind = 8 ) p3(2)
  real ( kind = 8 ), dimension(2,test_num) :: p3_test = reshape ( (/ &
    4.0D+00,  2.0D+00, &
    2.0D+00, -2.0D+00, &
...
!
  ...
  p1(1:dim_num) = p2(1:dim_num) &
    + r * (/ r8_cosd ( angle_deg ), r8_sind ( angle_deg ) /)
...
!
  ...
  call r8mat_transpose_print ( dim_num, n, v, '  #8, a five-pointed star:' )
...
!
  ...
  call r8mat_transpose_print ( dim_num, n, v, '  #10, double triangle:' )
...
subroutine tetrahedron_solid_angles_3d_test ( )
