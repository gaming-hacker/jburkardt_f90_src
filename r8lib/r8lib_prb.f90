...
!
  ...
  call r8vec_circular_variance_test ( )
  ...
  call r8vec_running_average_test ( )
  call r8vec_running_sign3_test ( )
  call r8vec_running_sum_test ( )
...
subroutine r8vec_circular_variance_test ( )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'R8VEC_CIRCULAR_VARIANCE_TEST'
  write ( *, '(a)' ) '  R8VEC_CIRCULAR_VARIANCE computes the circular variance of an R8VEC.'
  ...
  call r8vec_circular_variance ( n, x, circular_variance )

  write ( *, '(a)' ) ' '
  write ( *, '(a,g14.6)' ) '  Circular variance: ', circular_variance
...
subroutine r8vec_running_average_test ( )

!*****************************************************************************80
!
!! R8VEC_RUNNING_AVERAGE_TEST tests R8VEC_RUNNING_AVERAGE.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'R8VEC_RUNNING_AVERAGE_TEST'
  write ( *, '(a)' ) &
    '  R8VEC_RUNNING_AVERAGE returns the running averages of an R8VEC.'
  ...
  allocate ( s(1:n+1) )
  call r8vec_running_average ( n, r, s )
...
subroutine r8vec_running_sign3_test ( )

!*****************************************************************************80
!
!! R8VEC_RUNNING_SIGN3_TEST tests R8VEC_RUNNING_SIGN3.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'R8VEC_RUNNING_SIGN3_TEST'
  write ( *, '(a)' ) &
    '  R8VEC_RUNNING_SIGN3 returns the running sign3 of an R8VEC.'
  ...
  allocate ( s(1:n+1) )
  call r8vec_running_sign3 ( n, r, s )
...
subroutine r8vec_running_sum_test ( )

!*****************************************************************************80
!
!! R8VEC_RUNNING_SUM_TEST tests R8VEC_RUNNING_SUM.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'R8VEC_RUNNING_SUM_TEST'
  write ( *, '(a)' ) '  R8VEC_RUNNING_SUM returns the running sums of an R8VEC.'
...
!
  ...
  write ( *, '(a)' ) '  R8VEC SPLIT splits a vector into'
  write ( *, '(a)' ) '  entries less than and greater than a'
  write ( *, '(a)' ) '  splitting value.'
