...
!*****************************************************************************80
!
!! TEST02 tests the use of R8NSYMM_TEST01 to make a nonsymmetric test matrix.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST02'
  write ( *, '(a)' ) '  R8NSYMM_TEST makes an arbitrary size nonsymmetric matrix'
  write ( *, '(a)' ) '  with known eigenvalues and eigenvectors.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Real data is declared as "REAL ( KIND = 8 )".'

  call r8nsymm_test01 ( a, q, lambda )

  call r8mat_print ( n, n, a, '  The matrix A:' )
  call r8vec_print ( n, lambda, '  Eigenvalues' )
  call r8mat_print ( n, n, q, '  The eigenvector matrix Q:' )
